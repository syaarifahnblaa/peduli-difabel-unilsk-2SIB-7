           ...
           <div class="card-body">
                <div class="row">
                    <div class="col col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama staff konseling">
                    </div>
                    <div class="col col-md-6 form-group">
                        <label>Jenis konseling</label>
                        <input type="text" class="form-control"  id="jenis_konseling" name="jenis_konseling" placeholder="Masukkan jenis konseling">
                    </div>
                </div>
                <div class="row">
                    <div class="col col-md-6 form-group">
                        <label>Tanggal Konseling</label>
                        <input type="date" class="form-control" id="tanggal_konseling" name="tanggal_konseling" placeholder="Masukkan tanggal konseling">
                    </div>
                    <div class="col col-md-6 form-group">
