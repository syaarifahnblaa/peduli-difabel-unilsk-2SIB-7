    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Konseling</span>
            </a>
            <!-- Sidebar -->
            <div
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">konseling</a>
                    </div>
                </div>
                <!-- SidebarSearch Form -->
             ...
             with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/staff_konseling"
                                class="nav-link {{ request()->is('staff_konseling*') ? 'active' : '' }}">
        ...
        <footer class="main-footer">
            <!-- Default to the left -->
            <strong>Copyright &copy; </strong> Konseling.
        </footer>
    </div>
    <!-- ./wrapper -->
